module.exports = function (driver, webdriver) {
    var driver = driver,
        ...
        _hover, _get_visibles, _get_invisibles;
    ...
    _get_visibles = find_elements_based_on_visibility(true);
    _get_invisibles = find_elements_based_on_visibility(false);

    return {
        find_widget: function () {
        },
        _hover: _hover,
        _get_visibles: _get_visibles,
        _get_invisibles: _get_invisibles
    };
};
