module.exports = function (driver, webdriver) {
    var driver = driver, webdriver = webdriver,
        instance = {},
        find_elements_based_on_visibility, widget_index = 0;
    ...
    instance.find_widget = function (target) {
        ...
        return driver.executeScript(
            ...
            "                mutation.addedNodes[0].className += \" mutation_widget" + widget_index + "\";" +
            "            }" +
            "        });" +
            "    });" +
            ...
            return driver.findElements({css: ".mutation_widget" + widget_index});
