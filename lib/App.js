module.exports = function (driver, webdriver) {
    ...
    instance.find_widget = function (target) {
        return instance._get_invisibles().then(function (invisibles) {
            return instance._get_visibles().then(function (visibles_before) {
                var promises = [];
                instance._hover(target);
                return instance._get_visibles().then(function (visibles_after) {
